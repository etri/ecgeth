...
var (
	...
	EcConnectorUrlFlag = cli.StringFlag{
		Name:  "ecconnector.url",
		Usage: "External Consensus Connection URL configuration",
		Value: "https://127.0.0.1:8780",
	}

	EcConnectorSomeParamFlag = cli.StringFlag{
		Name:  "ecconnector.someparam",
		Usage: "External Consensus Connection any value if needed, just for testing",
		Value: "any",
	}
)
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	//for ecconnector configuration by yim, etri
	SetEcConnectorConfig(ctx, &cfg.EcConnectorConfig)
	//end yim
...
//for ecconnector by yim, etri
func SetEcConnectorConfig(ctx *cli.Context, cfg *ecconnector.Config) {

	if ctx.GlobalIsSet(EcConnectorUrlFlag.Name) {
		cfg.EcUrl = ctx.GlobalString(EcConnectorUrlFlag.Name)
	}

	if ctx.GlobalIsSet(EcConnectorSomeParamFlag.Name) {
		cfg.EcUrl = ctx.GlobalString(EcConnectorSomeParamFlag.Name)
	}
}
