...
var (
	...
	//for external consensus, externalconsensus parameter(nil) added
...
type ChainConfig struct {
	...
	ExternalConsensus *ExternalConsensusConfig `json:"externalConsensus,omitempty"`
	//end yim
}
...
func (c *ChainConfig) String() string {
	...
	case c.Clique != nil:
		engine = c.Clique
	//by yim, etri
	case c.ExternalConsensus != nil:
		engine = c.ExternalConsensus
	//end
	default:
		engine = "unknown"
	}
